...
| `⛔ Выключить` / `▶️ Включить` | Немедленно остановить или вернуть работу |
| `⏸ Пауза` | Выбор паузы на 1, 3, 8 или 24 часа |
| `🗓 Сегодня` | Агрегаты действий за локальные сутки |
| `⚠️ Включить live` | Запросить переход из dry-run с отдельным подтверждением |
