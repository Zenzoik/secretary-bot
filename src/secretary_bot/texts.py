...
BUTTON_MUTE = "⏸ Пауза"
BUTTON_DRY_RUN = "🧪 Лише тестові прев’ю"
...
MASTER_ACCESS_REQUEST = (
    "👤 Отримано новий запит доступу. Відкрийте розділ «Користувачі» у мініаппі."
)
ACCESS_ALREADY_ACTIVE = "Доступ уже активний. Відкрийте меню бота для налаштувань."
...
USER_APPROVED_NOTICE = (
    "✅ Доступ підтверджено. Кнопка налаштувань доступна в меню бота. "
    "Підключіть бота в Chat Automation для завершення налаштування."
)
...
REPLY_PERMISSION_RESTORED_ALERT = (
    "✅ Право відповідати повернулося, але автовідповіді досі зупинені. "
    "Увімкніть їх у панелі: кнопка «Налаштування» біля поля вводу."
)
