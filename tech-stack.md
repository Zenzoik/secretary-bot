...
1. **Требуется ли Telegram Premium** на аккаунте владельца. Источники противоречат друг другу: официальная MTProto-документация говорит, что не требуется; сторонние обзоры утверждают обратное. Проверяется тестовым аккаунтом за 15 минут.
...
| Telegram Premium (если подтвердится необходимость) | ~$5 |
| **Итого** | **~$15–25** |
